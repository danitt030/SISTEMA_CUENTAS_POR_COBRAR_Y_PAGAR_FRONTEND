...
export const getModulesByRole = (rol) => {
  const moduleMap = {
    ADMINISTRADOR_ROLE: [
      { path: "/usuarios", label: "Usuarios", icon: "US", color: "#0d6efd" },
      { path: "/clientes", label: "Clientes", icon: "CL", color: "#198754" },
      { path: "/proveedores", label: "Proveedores", icon: "PR", color: "#fd7e14" },
      { path: "/facturas-cobrar", label: "Facturas Cobrar", icon: "FC", color: "#dc3545" },
      { path: "/facturas-pagar", label: "Facturas Pagar", icon: "FP", color: "#ffc107" },
      { path: "/cobros", label: "Cobros", icon: "CB", color: "#28a745" },
      { path: "/pagos", label: "Pagos", icon: "PG", color: "#17a2b8" },
      { path: "/reportes", label: "Reportes", icon: "RP", color: "#6f42c1" },
      { path: "/auditoria", label: "Auditoría", icon: "AU", color: "#6c757d" },
      { path: "/ia", label: "Análisis IA", icon: "IA", color: "#ff6b6b" },
    ],
    ...
    CLIENTE_ROLE: [
      { path: "/cliente-portal", label: "Mi Portal", icon: "MP", color: "#0d6efd" },
    ],
  };
...
export const getReportesByRole = (rol) => {
  const todosReportes = [
    { id: "saldos", nombre: "Resumen de Saldos", icono: "RS" },
    { id: "proveedor", nombre: "Resumen por Proveedor", icono: "RPV" },
    { id: "cliente", nombre: "Resumen por Cliente", icono: "RCL" },
    { id: "vencer", nombre: "Facturas por Vencer", icono: "FV" },
    { id: "vencidas", nombre: "Facturas Vencidas", icono: "FVN" },
    { id: "cobrabilidad", nombre: "Cobrabilidad", icono: "COB" },
    { id: "pagabilidad", nombre: "Pagabilidad", icono: "PAG" },
    { id: "estado", nombre: "Facturas por Estado", icono: "EST" },
    { id: "topClientes", nombre: "Top Clientes Deudores", icono: "TOPC" },
    { id: "topProveedores", nombre: "Top Proveedores", icono: "TOPP" },
    { id: "comisiones", nombre: "Análisis de Comisiones", icono: "COM" }
  ];
