...
export const GerenteDashboard = () => {
  ...
  const stats = [
    { label: "Clientes", value: "0", color: "#198754" },
    { label: "Facturas", value: "0", color: "#dc3545" },
    { label: "Cobros Hoy", value: "Q0.00", color: "#28a745" },
    { label: "En Cartera", value: "Q0.00", color: "#6f42c1" },
  ];
